...
//! defined automatically for any type that can be a component (which is any type that implements
//! the [`Any`] trait), so users will be unable to implement it manually.
//!
